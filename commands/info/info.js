...
module.exports.run = async(client, message, args) => {
    ...
    .setDescription(`More Info About [${client.user.username}]( https://discord.com/oauth2/authorize?client_id=849084039763591179&scope=bot&permissions=4228906239)`)
    .addField("🔹__Version__", "1.0.7", true)
    .addField('📚__Libary__', "**Discord.JS**    ", true)
    .addField('__Creators__', "adnxn.", true)
